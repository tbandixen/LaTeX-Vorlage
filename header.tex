...
\usepackage[pdfauthor={Thomas Bandixen}, pdftitle={Seminararbeit Information Retrieval FS14 Studiengang Informatik - Evaluierung der Retrieval-Leistung einer Search Engine am Beispiel der Suche in Programmcode}, colorlinks=true,linkcolor=black,citecolor=black,plainpages=false]{hyperref}
\usepackage{textcomp}
...
\usepackage[acronym,section=section,hyperfirst=false]{glossaries}
